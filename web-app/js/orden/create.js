...
Ext.onReady(function(){
    Ext.apply(Ext.form.VTypes,{
        ...
        numdocexistsText:'NÃºmero de documento ya existe',
                ...
                Ext.Ajax.request(
                    {
                        ...
                        failure: function (response, options) {
                            Ext.Msg.show({
                                title:'Error',
                                msg:'Se produjo un error de comunicaciÃ³n',
    ...
    function buscarClienteVenta(){
        ...
        var grid = Ext.create('Ext.grid.Panel',{
            ...
            columns :[
                ...
                {text:'RazÃ³n Social', dataIndex:'razonSocial', width:250},
                {text:'SituaciÃ³n I.V.A', dataIndex:'situacionIVA', width:100},
                {
                    xtype:'actioncolumn',
                    width:30,
                    sortable:false,
            ...
            items:[
                {
                    ...
                    border:false,
                    items:[
                        {xtype:'textfield',id:'filtroRazonSocialId',fieldLabel:'Filtrar por razÃ³n social'},
    ...
    function confirmarorden(){
        if (storeGridDetalle.count()==0){
            Ext.Msg.show({
                title:'Error',
                msg:'Agregue al menos una lÃ­nea de detalle de Animales',
                buttons: Ext.Msg.OK,
                icon: Ext.Msg.ERROR
            });
            return;
        ...
        var loadMask = new Ext.LoadMask(Ext.getBody(), {msg:'Enviando InformaciÃ³n'});
        loadMask.show();
        Ext.Ajax.request({
            url:saveOrdenUrl,
            params:{
        ...
        items:[
            {
                ...
                layout:'anchor',
                margin:'10 10 10 10',
                title:'Paso 2 - Datos de ExposiciÃ³n',
                defaults : {
                    autoScroll : true,
                    msgTarget:'under',
                    xtype:'textfield'
                ...
                items:[
                    {
                        ...
                        xtype:'combo',
                        fieldLabel:'AÃ±o de ExposiciÃ³n',
                        forceSelection: true,
                        name:'anioExposicion',
                        //allowBlank:false,
                        //editable:false,
            ...
            ,{
                ...
                title:'Paso 3 - ConfecciÃ³n del Detalle',
                items:[
                    {
                ...
                buttons:[
                    {
                        ...
                        handler: function(){
                            /*reactivar luego estas lineas
                             ...
                             Ext.Msg.show({
                             title:'Error',
                             msg:'Agregue al menos una lÃ­nea de detalle',
                             buttons: Ext.Msg.OK,
                             icon: Ext.Msg.ERROR
                             });
                             return;
                ...
                items:[
                    ...
                    {
                        xtype:'combo',
                        fieldLabel:'CondiciÃ³n de OperaciÃ³n',
                        forceSelection:true,
                        name:'formadePago',
                        id:'formadePagoId',
                        allowBlank:false,
