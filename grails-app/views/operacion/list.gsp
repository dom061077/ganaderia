			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="nombre" title="${message(code: 'operacion.nombre.label', default: 'Nombre')}" />
				...
				<g:each in="${operacionInstanceList}" status="i" var="operacionInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${operacionInstance.id}">${fieldValue(bean: operacionInstance, field: "nombre")}</g:link></td>
