	...
	<body>
		...
		<div id="show-operacion" class="content scaffold-show" role="main">
			...
			<ol class="property-list operacion">
				...
				<g:if test="${operacionInstance?.nombre}">
				<li class="fieldcontain">
					<span id="nombre-label" class="property-label"><g:message code="operacion.nombre.label" default="Nombre" /></span>
					
						<span class="property-value" aria-labelledby="nombre-label"><g:fieldValue bean="${operacionInstance}" field="nombre"/></span>
			...
			<g:form>
				<fieldset class="buttons">
					...
					<g:link class="edit" action="edit" id="${operacionInstance?.id}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
