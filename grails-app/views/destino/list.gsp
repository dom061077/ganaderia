	...
	<body>
		...
		<div id="list-destino" class="content scaffold-list" role="main">
			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="descripcion" title="${message(code: 'destino.descripcion.label', default: 'Descripcion')}" />
				...
				<g:each in="${destinoInstanceList}" status="i" var="destinoInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${destinoInstance.id}">${fieldValue(bean: destinoInstance, field: "descripcion")}</g:link></td>
			...
			<div class="pagination">
				<g:paginate total="${destinoInstanceTotal}" />
			</div>
		</div>
	</body>
</html>
